...
import {FormGroup, FormControl, Validators, ValidationErrors, FormGroupDirective, NgForm, FormBuilder} from '@angular/forms';
...
export class AdminCompanyAddPage implements OnInit {
    brandOption = {
        color: ['#69EBB7', '#5F8FF3'],
        tooltip: {
            trigger: 'item',
